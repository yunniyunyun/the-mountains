    ...
    <div class="container mb-5">
      <div class="d-none d-md-flex justify-content-center text-secondary" style="margin-top: 60px;">
        <div class="position-relative m-4" style="width: 60%;">
          ...
          <h5 class="position-absolute" style="top: -26px; left: calc(32% + (33% - 5rem)/2); color: #1FBA82;">填寫資料</h5>
          ...
          <h5 class="position-absolute" style="top: -26px; left: calc(65% + (33% - 5rem)/2); color: #1FBA82;">訂單完成</h5>
